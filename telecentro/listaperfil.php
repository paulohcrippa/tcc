	...
	<div id="wrapper"> <!--inicio da div wrapper-->
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header"> Perfils do Sistema<small>  </small> </h1>
							<ol class="breadcrumb">
						...
						<table class = " table ">
							...
							<tbody>
									<?php
											...
											?>
											<td> 
												<a class='btn btn-xs btn-primary' href='principal.php?link=7&id=<?php echo $linhas['CDPERFIL'];?>'>
													<type='button' class="glyphicon glyphicon-eye-open"/></a> 

												<a class='btn btn-xs btn-warning'  href='principal.php?link=4&id=<?php echo $linhas['CDPERFIL'];?>'>
												<type = 'button'  class='glyphicon glyphicon-pencil'/></a>

												<a class='btn btn-xs btn-danger' data-toggle="modal" data-target="#delete-modal" >
												<type='' class='glyphicon glyphicon-trash'/></a> 
